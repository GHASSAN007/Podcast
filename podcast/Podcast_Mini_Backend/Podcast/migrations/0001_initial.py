    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('podcast', models.FileField(upload_to='podcasts/', validators=[CODE_FOR_APPS.validators.validate_podcast_extension])),
                ('Thumbnail', models.ImageField(upload_to='Thumbnail/', validators=[CODE_FOR_APPS.validators.validate_thumbnail_extension])),
